...
function Privacy() {
  return (
    <div className="container">
      ...
      <p>MunchPrep ("us", "we", or "our") operates the https://www.munchprep.net website (hereinafter referred to as the "Service").</p>
      ...
      <ul>
        <li>
          ...
          <p>Service is the https://www.munchprep.net website operated by MunchPrep</p>
        </li>
        <li>
      ...
      <h2>Use of Data</h2>
      <p>MunchPrep uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>MunchPrep may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of MunchPrep</li>
      ...
      <ul>
        <li>By email: schoinh@gmail.com</li>
      </ul>
    </div>
  );
}
